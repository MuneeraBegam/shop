...
<li><a href=" <c:url value="/index1" />">Home</a>
</li>
...
<span
class="glyphicon glyphicon-shopping-user">
...
<li><a href="<c:url value="/cart/getCartById" />">
<span
...
<span
class="glyphicon glyphicon-log-user"></span> SignUp</a>
</li>
